...
import { concat } from './modules/array/concat/concat';
import { create } from './modules/array/create/create';
import { enumerate } from './modules/array/enumerate/enumerate';
import { filter } from './modules/array/filter/filter';
import { map } from './modules/array/map/map';
import { reduce } from './modules/array/reduce/reduce';
import { slice } from './modules/array/slice/slice';
import { take } from './modules/array/take/take';
import { zip } from './modules/array/zip/zip';
import { thread } from './modules/async/thread';
import { carry } from './modules/function/carry/carry';
import { flip } from './modules/function/flip/flip';
import { partial } from './modules/function/partial/partial';
import { pipeFromRight } from './modules/function/pipeFromRIght/pipeFromRight';
